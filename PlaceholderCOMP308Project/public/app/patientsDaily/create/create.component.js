            ...
            CreateComponent = /** @class */ (function () {
                ...
                CreateComponent.prototype.create = function () {
                    ...
                    this._patientsDailyService.create(this.patientDaily)
                        .subscribe(function (createdPatientDaily) { return _this._router.navigate(['/patientsDaily', createdPatientDaily._id]); }, function (error) { return _this.errorMessage = error; });
                };
