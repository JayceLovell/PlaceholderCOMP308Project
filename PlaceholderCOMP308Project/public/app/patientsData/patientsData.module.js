System.register(["@angular/core", "@angular/common", "@angular/forms", "@angular/router", "./patientsData.routes", "./patientsData.component", "./list/list.component", "./view/view.component", "../patientsData/tip/view/view.component", "./edit/edit.component", "../patientsData/tip/edit/edit.component"], function (exports_1, context_1) {
    "use strict";
    ...
    var core_1, common_1, forms_1, router_1, patientsData_routes_1, patientsData_component_1, list_component_1, view_component_1, view_component_2, edit_component_1, edit_component_2, PatientsDataModule;
                ...
                PatientsDataModule = __decorate([
                    core_1.NgModule({
                        ...
                        declarations: [
                            ...
                            view_component_2.ViewTipComponent,
                            edit_component_1.EditComponent,
                            edit_component_2.EditTipComponent
                        ]
                    })
                ], PatientsDataModule);
